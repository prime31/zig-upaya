...
pub fn rgbToU32(r: i32, g: i32, b: i32) ImU32 {
    ...
    //return igColorConvertFloat4ToU32(.{ .x = @intToFloat(f32, r) / 255, .y = @intToFloat(f32, g) / 255, .z = @intToFloat(f32, b) / 255, .w = 1 });
...
pub fn rgbaToU32(r: i32, g: i32, b: i32, a: i32) ImU32 {
    ...
    //return igColorConvertFloat4ToU32(.{ .x = @intToFloat(f32, r) / 255, .y = @intToFloat(f32, g) / 255, .z = @intToFloat(f32, b) / 255, .w = @intToFloat(f32, a) / 255 });
